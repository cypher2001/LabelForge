# LabelForge User Manual

A guide to designing and printing labels with the LabelForge label designer.
...
LabelForge works in millimetres by default. If your label stock is sold in inches, set **Units** to `Inches (in)` in Print Settings.
