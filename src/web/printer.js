...
// M110-series specific commands
// Verified against M110/M110S hardware
const M110_CMD = {
...
export async function print(transport, rasterData, options = {}) {
  ...
  if (isTSPL) {
    ...
    // M110/M110S/M120 use their own protocol
